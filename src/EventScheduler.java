...
final class EventScheduler
{
   ...
   protected void updateOnTime(long time)
   {
   ...
   protected void scheduleEvent(Entity entity, Action action, long afterPeriod)
   {
   ...
   protected void unscheduleAllEvents(Entity entity)
   {
